  ...
  return (
    ...
    <section className="max-w-5xl mx-auto p-8  rounded-lg ">
      ...
      <article className="mb-12 space-y-6">
        ...
        <p className="text-justify  leading-relaxed">
          Entre las plagas más relevantes se encuentran la carpocapsa (<em className="italic text-blue-800">Cydia pomonella</em>), principal causante de daños en los frutos; la arañuela roja europea (<em className="italic text-blue-800">Panonychus ulmi</em>), que afecta el follaje; el psílido del peral (<em className="italic text-blue-800">Cacopsylla pyri</em>), que debilita la planta al alimentarse de su savia; y la polilla de la manzana (<em className="italic text-blue-800">Grapholita molesta</em>), que también puede atacar frutos y brotes. Además, enfermedades fúngicas como el moteado (<em className="italic text-blue-800">Venturia pirina</em>) y la sarna afectan tanto hojas como frutos, obligando a los productores a implementar un manejo integrado de plagas para garantizar una producción sostenible y de calidad.
        </p>
      </article>
